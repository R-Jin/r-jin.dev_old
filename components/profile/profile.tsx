...
const Profile = () => {
    return (
        <div className='flex flex-col pt-10 items-center space-y-10 md:flex-row md:space-x-[50px] md:space-y-0 md:pt-28'>
            <div className='rounded-full w-[250px] border-[14px] dark:border-darkLightBackground shadow-lg md:w-[500px] flex-auto'>
            ...
            <div className="flex flex-col justify-self-center flex-auto md:w-[1200px]">
                <h3 className='font-serif text-sm dark:text-darkAccent pb-1 md:text-base'>Hi, my name is</h3>
